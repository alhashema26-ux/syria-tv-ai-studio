...
async def process_transcript(
    ...
    include_keyword_map: str = Form(default=None),
):
    ...
    options = {
        ...
        "include_keyword_map": bool(include_keyword_map),
    }
    ...
    if checkpoint_path.exists():
        try:
            with open(checkpoint_path, encoding="utf-8") as f:
                ...
                all_steps = ["analysis", "titles", "description", "thumbnail", "evaluation", "social_media", "keyword_map"]
