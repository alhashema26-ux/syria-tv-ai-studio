...
async def chat_stream(request: Request):
    ...
    system_prompt = "You are an expert editorial assistant at Syria TV. Help the editor improve content, suggest alternatives, and answer questions. Always respond in Arabic."
    if context:
        system_prompt += "\n\nReport context:\n" + context
